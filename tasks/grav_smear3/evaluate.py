    ...
    try:
        ...
        try:
            ...
            if "infeasible" in es.lower():
                ...
                hint = ("" if pm == 1 else
                        " KNOWN WALL: at p_max>1 the J=38/40 audit sandwich "
                        "is outmatched (40-digit coefficients); set "
                        "'j_audit': 36 to certify at slightly narrower "
                        "scope — a champion-columns design at p_max='9/8', "
                        "j_audit=36 certifies at c=3.0495.")
