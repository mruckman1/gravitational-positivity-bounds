"""ROUND 7: the round-4 recipe (Bessel margins ONLY, generous reserve) at
...
ART = "results/positivity/artifacts/floor4_pm17o16_functional.json"
print("=== ROUND 7: round-4 recipe at p_max=17/16 (bessel margins only, "
      "give=0.05, normalized rows) ===", flush=True)
t0 = time.time()
try:
