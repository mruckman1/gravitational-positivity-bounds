...
ART = "results/positivity/artifacts/round9b_basis_functional.json"
print("=== ROUND 9b (give=0.16): margin recipe at p_max=9/8 + X8(0,2,4,6) + E2(0,2,4,6,8) towers ===", flush=True)
t0 = time.time()
try:
